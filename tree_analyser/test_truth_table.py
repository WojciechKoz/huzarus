...
class TestTruthTable(unittest.TestCase):
    ...
    def test_output(self):
        ...
        self.assertEqual(run_test('a or b and a'), run_test('a or (b and a)', 'a or b and a'))

        self.assertEqual(run_test('a implies b implies c'), run_test('a implies (b implies c)', 'a implies b implies c'))

        self.assertEqual(run_test('a'), [False, True])

        self.assertEqual(run_test('not(a and b)', 'not a and b'), run_test('not a or not b'))
